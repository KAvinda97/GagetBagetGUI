...
public class FunderServlet {
	...
	public String insertFunder(String name, String email, String tel, String gender, String donation, String desc)
	{
		...
		try
		{
			...
			String query = " insert into fundergui (`funderID`,`funderName`,`funderEmail`, `funderTel`, `funderGender`,`funderDonation`,`funderDesc`)"
			+ " values (?, ?, ?, ?, ?, ?, ?)";
	...
	public String deleteFunder(String funderID)
	{
		...
		try
			...
			// create a prepared statement
			String query = "delete from fundergui where funderID=?";
			PreparedStatement preparedStmt = con.prepareStatement(query);
